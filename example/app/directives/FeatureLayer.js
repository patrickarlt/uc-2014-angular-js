define([
  ...
  app.directive('esriFeatureLayer', function($parse){
    ...
    return {
      ...
      controller: function($scope, $element, $attrs, $parse){
       ...
       // listen for click events and expost them as broadcasts on the scope and using the scopes click handler
      ...
      link: function(scope, element, attrs, controllers){
        ...
        var layer = layerController.getLayer();

        if(attrs.featureClick){
          var fn = $parse(attrs.featureClick);
